...
export default function SignupPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    // NOTE: This is a placeholder for the actual signup logic.
    // In a real application, you would call your Firebase auth function here.
    console.log(values);
  }
  ...
  return (
    <Card className="mx-auto w-full max-w-sm bg-background/80 backdrop-blur-sm">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Join us to discover the wonders of Jharkhand.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
